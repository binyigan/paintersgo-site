...
(function() {
    ...
    // 1. 安全检查：确保 THREE 已经加载
    if (typeof THREE === 'undefined') {
        console.error('STLLoader: THREE is not defined.');
        return;
    }
            ...
            function parseBinary( data ) {
                ...
                for ( let face = 0; face < faces; face ++ ) {
                    ...
                    for ( let i = 1; i <= 3; i ++ ) {
                        ...
                        if ( hasColors ) {
                            if (SRGBColorSpace) color.setRGB( r, g, b, SRGBColorSpace );
            ...
            function parseASCII( data ) {
                ...
                while ( ( result = patternSolid.exec( data ) ) !== null ) {
                    ...
                    while ( ( result = patternFace.exec( solid ) ) !== null ) {
                        ...
                        if ( normalCountPerFace !== 1 ) console.error( 'THREE.STLLoader: Normal issue at face ' + faceCounter );
                        if ( vertexCountPerFace !== 3 ) console.error( 'THREE.STLLoader: Vertex issue at face ' + faceCounter );
                        faceCounter ++;
                    }
    ...
    // 4. 将 Loader 挂载到全局 THREE 对象上
    THREE.STLLoader = STLLoader;
    console.log("STLLoader registered successfully");
