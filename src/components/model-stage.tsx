...
export function ModelStage() {
  return (
    <div className="relative h-[32rem] overflow-hidden rounded-[1.7rem] border border-white/10 bg-[radial-gradient(circle_at_top,#8c6330_0%,#3b2d22_30%,#171311_68%)]">
      ...
      <Canvas camera={{ position: [0.18, 0.52, 4.85], fov: 31 }} shadows dpr={[1, 1.5]}>
      ...
      <div className="pointer-events-none absolute inset-x-5 bottom-5 z-10 grid gap-3 md:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[1.4rem] border border-white/10 bg-black/24 px-4 py-4 backdrop-blur-md">
